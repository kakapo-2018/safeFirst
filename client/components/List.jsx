...
const List = (props) => {
  return (
    <div className="columns">
        ...
        <label className="column is-6 label is-large has-text-centered"> <LostList /> </label>
    
        <label className="column is-6 label is-large has-text-centered"> <FoundList /> </label>
